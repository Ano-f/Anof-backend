...
def recommend():
    ...
    user = pd.read_csv('Anof_flask\Anof_flask\유저(id).csv')
    allergy = pd.read_csv('Anof_flask\Anof_flask\알레르기 테이블.csv')
    ingredient = pd.read_csv('Anof_flask\Anof_flask\성분 테이블.csv')
    ...
    likeProduct = pd.read_csv('Anof_flask\Anof_flask\선호.csv')
